...
class PTAccuracyAwareTrainingRunner(BaseAccuracyAwareTrainingRunner):
    ...
    def load_best_checkpoint(self, model):
        ...
        if not possible_checkpoint_rates:
            nncf_logger.warning('Could not satisfy the defined accuracy degradation criteria '
                                'during training. You probably need to increase the amount of training epochs')
